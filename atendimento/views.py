...
def imprimeSenha(request, atendimento):
    ...
    try:
        ...
        try:
            win32print.WritePrinter(printer, "\x1Ba".encode('utf-8')) # normal font
            win32print.WritePrinter(printer, "\b SENHA:\n\n".encode('utf-8'))
            win32print.WritePrinter(printer, "\x1B!\x20".encode('utf-8')) # bold font
            win32print.WritePrinter(printer, "\x1BE".encode('utf-8')) # normal font
            win32print.WritePrinter(printer, f"{senha}\n\n".encode('utf-8'))
            win32print.WritePrinter(printer, "\x1B!\x10".encode('utf-8')) # normal font
